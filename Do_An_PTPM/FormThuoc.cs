...
namespace Do_An_CNPM
{
    public partial class FormThuoc : Form
    {
        ...
        private void FormThuoc_Load(object sender, EventArgs e)
        {
            ...
            Bitmap anh = new Bitmap(@"C:\Users\Thai Bao\Desktop\PTPM\PTPM\WebTimThuoc\WebTimThuoc\Content\images\acetylsalicylic.jpg");
        ...
        private void GVThuoc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Bitmap anh = new Bitmap(@"C:\Users\Thai Bao\Desktop\PTPM\PTPM\WebTimThuoc\WebTimThuoc\Content\images\" + txthinhanh.Text);
                pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
                pictureBox1.Image = (Image)anh;
